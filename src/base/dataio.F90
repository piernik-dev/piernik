...
!
      ...
      tot_mfly = mpi_addmul(b(iby, cg%is:cg%ie, cg%js:cg%je, cg%ks:cg%ke), cg%dx*cg%dz/dom%nyd)
      tot_mflz = mpi_addmul(b(ibz, cg%is:cg%ie, cg%js:cg%je, cg%ks:cg%ke), cg%dx*cg%dy/dom%nzd)
#ifdef ISO
