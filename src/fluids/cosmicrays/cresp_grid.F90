...
contains
 ...
 subroutine cresp_update_grid
  ...
  use initcrspectrum, only: spec_mod_trms, virtual_e, virtual_n !, crel
...
!                         print *, cg%u(iarr_cre_n, i, j, k)
!                         print *,cg%u(iarr_cre_e, i, j, k)
...
!----------------------------------------------------------------------------------------------------      
 subroutine cresp_init_grid
  ...
  implicit none
    ...
    type(grid_container),   pointer :: cg
    real(kind=8), allocatable, dimension(:)  :: cresp_arguments
    real(kind=8)                             :: dt_cre_tmp, bump_amp0, max_amp_cr
    type(spec_mod_trms)  :: sptab
