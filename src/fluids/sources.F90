...
#ifdef CRESP
         u1(:, iarr_crspc_n(:)) = max(smallcren, u1(:, iarr_crspc_n(:)))        !< \deprecated BEWARE - this line refers to CRESP number density component
         u1(:, iarr_crspc_e(:)) = max(smallcree, u1(:, iarr_crspc_e(:)))
#endif /* CRESP */
