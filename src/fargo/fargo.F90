...
!<
   subroutine fargo_mean_omega
      ...
      do while (associated(curl))
         ...
         if (.not.allocated(curl%local_omega)) allocate(curl%local_omega(curl%l%off(xdim):curl%l%off(xdim)+curl%n_d(xdim)-I_ONE, flind%fluids))
         if (.not.allocated(curl%cell_count)) allocate(curl%cell_count(curl%l%off(xdim):curl%l%off(xdim)+curl%n_d(xdim)-I_ONE))
...
!<
   subroutine get_fargo_vels(dt)
      ...
      do while (associated(curl))
         ...
         if (.not. allocated(curl%omega_mean)) allocate(curl%omega_mean(curl%l%off(xdim):curl%l%off(xdim)+curl%n_d(xdim)-I_ONE, flind%fluids))
         if (.not. allocated(curl%omega_cr))   allocate(curl%omega_cr  (curl%l%off(xdim):curl%l%off(xdim)+curl%n_d(xdim)-I_ONE, flind%fluids))
         if (.not. allocated(curl%nshift))     allocate(curl%nshift    (curl%l%off(xdim):curl%l%off(xdim)+curl%n_d(xdim)-I_ONE, flind%fluids))
