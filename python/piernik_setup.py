...
def setup_piernik(data=None):
    ...
    try:
        ...
        for line in fileinput.input([rundir + 'piernik.def'], inplace=True):
            if fileinput.isfirstline():
                print "#warning Do not edit this file.\n#warning This if just a copy of " + objdir + "/piernik.def.\n#warning any changes made here will have no effect.\n\n"
            print line,
    except IOError:
