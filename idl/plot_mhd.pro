...
;===============================================================================
 ...
 if(var EQ 'den1' OR var EQ 'ene1' ) then ylog=1
  ...
  if(var EQ 'vlx1') then begin
    amin= 0.0 
    amax= 0.0 
  endif
  if(var EQ 'vly1') then begin
    amin= 0.0
    amax= 0.0
  endif
  if(var EQ 'vlz1') then begin
    amin= 0.0
    amax= 0.0
  endif
  ...
  if(nx eq 1) then begin 
    ...
    ix = nxd/2;+nb ;nz/2 ;nzd/2 ; nz/2 ; 3*nz/4 
  endelse

  if(ny eq 1) then begin 
    iy = 1
  endif else begin
    iy = nyd/2;+nb ;nz/2 ;nzd/2 ; nz/2 ; 3*nz/4 
  endelse
...
IF(slices EQ 'y') THEN BEGIN
  ...
  image_yz = REFORM(a(ix-1,*,*),nya,nza)
